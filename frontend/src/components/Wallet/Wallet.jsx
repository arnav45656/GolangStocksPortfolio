...
function Wallet() {
    ...
    // const handleDeposit = () => {
    //     const depositAmount = Number(amountDeposit);
    ...
    //     const transferAmount = Number(amountTransfer);
                ...
                <TableContainer border='1px solid #ccc' borderRadius='8px' p='5px' >
                    <Table variant='unstyled'>
                        <Tbody>
                            ...
                            <Tr>
                                <Td textAlign='center'>Balance</Td><Td textAlign='center'>{formatCurrency(wallet.deposit -wallet.investment + Number(amountDeposit) )}</Td>
                            </Tr>
                        </Tbody>
                    </Table>
                </TableContainer>
